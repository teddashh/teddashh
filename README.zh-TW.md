...
<p align="center">
  <picture>
    ...
    <img src="./assets/profile-hero-light.svg" width="100%" alt="Ted Huang — 把企業 IT 經驗用在 AI Agent 系統。">
  </picture>
</p>
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="./projects/README.md#traditional-chinese"><strong>瀏覽 9 個完整案例 →</strong></a>
  &nbsp;·&nbsp;
...
<table width="100%">
  <tr>
    ...
    <td width="33%" align="center">
      <strong>9 個作品</strong><br><sub>公開案例研究</sub>
    </td>
    <td width="33%" align="center">
...
<table width="100%">
  ...
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/multi-ai-chat.md#traditional-chinese">Multi-AI Chat</a></strong><br>
  ...
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/ai-brainstorming.md#traditional-chinese">AI Brainstorming</a></strong><br>
...
<table width="100%">
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/openclaw-hermes-watcher.md#traditional-chinese">openclaw-hermes-watcher</a></strong><br>
  ...
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/clawd-lobster.md#traditional-chinese">Clawd-Lobster</a></strong><br>
  ...
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/claude-idea-review-skill.md#traditional-chinese">Claude Idea Review Skill</a></strong><br>
  ...
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/mcp-memory-server.md#traditional-chinese">MCP Memory Server</a></strong><br>
...
<table width="100%">
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/idn-homograph-example.md#traditional-chinese">Homograph Attack Demo</a></strong><br>
  ...
  <tr>
    <td width="32%" valign="top">
      <strong><a href="./projects/zhan-dou-tuo-luo.md#traditional-chinese">AI 教你打陀螺</a></strong><br>
...
<p align="right"><a href="./projects/README.md#traditional-chinese"><strong>瀏覽完整作品目錄 →</strong></a></p>
...
**台北，1985–2008。** 中央大學資工系；管理校園網路、共同開發營運至今 20+ 年的 MUD，也經營過全校最高人氣的 BBS 個版。

**美國，2008–現在。** 取得 CIS 碩士後，在真實企業裡做了近 20 年的身分、端點、ERP、BI、CRM 與資安維運。
